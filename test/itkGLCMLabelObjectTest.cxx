...
int itkGLCMLabelObjectTest( int , char ** )
{
  // The basic goal of this test to cover the methods of the class


  // check some template parameters for the super-class
  typedef itk::GLCMLabelObject< int, 3 > LabelObject1Type;
  typedef itk::GLCMLabelObject< int, 3, itk::LabelObject<int,3> > LabelObject2Type;
